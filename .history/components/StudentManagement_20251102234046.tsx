...
const styles = StyleSheet.create({
  ...
  backBtn: { paddingVertical: 2, paddingRight: 8, paddingLeft: 0 },
  backBtnText: { color: '#007AFF', fontSize: 14, fontWeight: '600', lineHeight: 16 },
  backBtnSpacer: { width: 0, height: 0 },
  ...
  label: { color: '#777', width: 90, fontSize: 13, lineHeight: 16 },
  ...
  btnTextDark: { color: '#111', fontWeight: '600', fontSize: 14 },
  ...
  modalLoading: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(0,0,0,0.05)' },

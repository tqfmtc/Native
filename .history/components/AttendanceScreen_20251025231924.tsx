...
export default function AttendanceScreen({ userData, onLogout }: AttendanceScreenProps) {
  ...
  const [isSidebarOpen, setIsSidebarOpen] = useState(false); // ONLY NEW STATE
  ...
  return (
    <View style={styles.container}>
      {/* Your Existing Sidebar - conditionally rendered */}
      {isSidebarOpen && (
        <SideBar 
      ...
      {/* Header with hamburger menu - ONLY SMALL CHANGE */}
      <View style={styles.header}>
        {/* NEW: Simple hamburger button */}
        <TouchableOpacity 
      ...
      {/* ALL YOUR EXISTING CODE BELOW - COMPLETELY UNCHANGED */}
...
const styles = StyleSheet.create({
  ...
  // NEW: Simple hamburger button styles
  hamburgerButton: {
    width: 30,
    height: 24,
    justifyContent: 'space-between',

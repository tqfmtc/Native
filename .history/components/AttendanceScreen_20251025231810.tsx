...
export default function AttendanceScreen({ userData, onLogout }: AttendanceScreenProps) {
  ...
  const HamburgerMenu = () => (
    <TouchableOpacity style={styles.hamburgerButton} onPress={toggleSidebar}>
      <View style={[styles.hamburgerLine, isSidebarOpen && styles.hamburgerLineActive1]} />
      <View style={[styles.hamburgerLine, isSidebarOpen && styles.hamburgerLineActive2]} />
      <View style={[styles.hamburgerLine, isSidebarOpen && styles.hamburgerLineActive3]} />
    </TouchableOpacity>
  );
...
const styles = StyleSheet.create({
  ...
  hamburgerLineActive1: {
    transform: [{ rotate: '45deg' }, { translateY: 10.5 }],

...
export default function MainApp() {
  ...
  const initializeApp = async () => {
    ...
    // Add timeout to prevent infinite loading - shorter for production
  ...
  const renderScreen = () => {
    switch (appState) {
      ...
      case 'network-error':
        return <NetworkErrorScreen onRetry={handleRetry} onSkipVersionCheck={handleSkipVersionCheck} onShowDebug={handleShowDebug} />;
      
      case 'debug':
        return <DebugScreen onClose={handleCloseDebug} />;
